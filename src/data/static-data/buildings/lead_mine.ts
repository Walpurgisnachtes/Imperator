...
let buildingName: MessageDescriptor = msg`Lead Mine`;
let buildingNameId: string = "building-lead-mine";
let buildingDescription: MessageDescriptor = msg`Provides lead, which is necessary for building, tools, and military equipment.`;
